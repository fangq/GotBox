...
begin
  Result :=
    'GotBox -- Dropbox-like file sync over GitHub private repos' + LineEnding +
    LineEnding +
    'Usage: gotbox [options]' + LineEnding +
    LineEnding +
    'Options:' + LineEnding +
    '  -d, --daemon   detach from the terminal and run in the background' + LineEnding +
    '  -h, --help     show this help and exit' + LineEnding;
end;
