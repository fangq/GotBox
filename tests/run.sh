...
TESTS="testgit testauth testlink testremote testsuper teststray testengine testworker testsync testrobust testrecover testtags testfilestatus testoverlayipc testrootlock testmultisync testhistory teste2e"
