...
TESTS="testgit testauth testcred testoauth testlog testlink testremote testsuper teststray testengine testworker testsync testrobust testrecover testtags testfilestatus testoverlayipc testrootlock testmultisync testhistory teste2e"
